...
from transformer_layer import qTransformerEncoderLayer
import math
...
class qTransformerModel(nn.Module):
    ...
    def __init__(self, ntoken: int, d_model: int, nhead: int, d_hid: int,
        ...
        encoder_layers = qTransformerEncoderLayer(d_model, nhead, d_hid, dropout)
        self.transformer_encoder = TransformerEncoder(encoder_layers, nlayers)
        self.encoder = nn.Embedding(ntoken, d_model)
        self.d_model = d_model
        self.decoder = qLinear(d_model, ntoken)
...
if quan:
    model = qTransformerModel(ntokens, emsize, nhead, d_hid, nlayers, dropout).to(device)
else:
