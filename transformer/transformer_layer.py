...
class qTransformerEncoderLayer(Module):
    ...
    def __init__(self, d_model: int, nhead: int, dim_feedforward: int = 2048, dropout: float = 0.1,
        ...
        self.linear1 = qLinear(d_model, dim_feedforward, **factory_kwargs)
        self.dropout = Dropout(dropout)
        self.linear2 = qLinear(dim_feedforward, d_model, **factory_kwargs)
    ...
    def __setstate__(self, state):
        super(qTransformerEncoderLayer, self).__setstate__(state)
...
class qTransformerDecoderLayer(Module):
    ...
    def __init__(self, d_model: int, nhead: int, dim_feedforward: int = 2048, dropout: float = 0.1,
                 ...
                 device=None, dtype=None) -> None:
        factory_kwargs = {'device': device, 'dtype': dtype}
        super(qTransformerDecoderLayer, self).__init__()
        self.self_attn = MultiheadAttention(d_model, nhead, dropout=dropout, batch_first=batch_first,
                                            **factory_kwargs)
    ...
    def __setstate__(self, state):
        ...
        super(qTransformerDecoderLayer, self).__setstate__(state)
